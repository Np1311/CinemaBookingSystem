...
require('header.html');
$profile = $_GET['curProfile'];
$oldPhone = $_GET['updateID'];
$userAccount = new user_update_controller;
$arr = $userAccount -> showUpdate($profile,$oldPhone);
...
<html>
    ...
    echo "<input type='text' name='first_name' id='first_name' value='" . $arr['fname'] . "' required><br><br>";
    echo '<label for="last_name">Last Name:</label>';
    echo "<input type='text' name='last_name' id='last_name' value='" . $arr['lname'] . "' required><br><br>";
    echo '<label for="email">Email:</label>';
    echo "<input type='email' name='email' id='email' value='" . $arr['email'] . "' required><br><br>";
    echo '<label for="date_of_birth">Date of Birth:</label>';
    echo "<input type='date' name='date_of_birth' id='date_of_birth' value='".$arr['dob']."'required><br><br>";
    echo '<label for="phone">Phone Number:</label>';
    echo "<input type='text' name='phone' id='phone' value='" . $arr['phone'] . "' required><br><br>";
    echo '<label for="pass">Password:</label>';
    echo "<input type='text' name='pass' id='pass' value='".$arr['password']."'required><br><br>";
